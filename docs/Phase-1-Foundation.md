...
Create the following entities in `SupportHub.Core/Entities/`. All inherit from `BaseEntity`. Use navigation properties where appropriate. Do NOT use data annotations — all configuration will be Fluent API.
